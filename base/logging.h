...
// Simplified logging: just forwards the format string as-is (no fmt)
...
// Variadic overload that ignores extra args and just prints the format string.
// For full printf-style formatting, use PrintfLogMessage.
