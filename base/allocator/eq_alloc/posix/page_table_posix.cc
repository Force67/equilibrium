...
byte* PageTable::Reserve(void* requested_range_start_address,
  ...
  return reinterpret_cast<byte*>(mmap(requested_range_start_address, block_size,
                                      PROT_NONE, MAP_PRIVATE | MAP_ANONYMOUS, -1,
                                      0));
}
...
void* PageTable::Allocate(void* requested_range_start_address,
                          ...
                          bool use_initialize) {
  NativePageProtectionType protect_flags =
