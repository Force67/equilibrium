...
QT_MOC_LITERAL(1, 19, 9), // "OnConfirm"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 4) // "text"

    },
    "forms::InputDialog\0OnConfirm\0\0text"
};
...
void forms::InputDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->OnConfirm((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (InputDialog::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&InputDialog::OnConfirm)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void forms::InputDialog::OnConfirm(const QString & _t1)
{
