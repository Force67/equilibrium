...
VulkanSurface::~VulkanSurface() {
  if (surface_handle_ != VK_NULL_HANDLE) {
    vkDestroySurfaceKHR(instance_.instance, surface_handle_, nullptr);
  }
}

bool VulkanSurface::Initialize(void* os_hinstance, void* os_window_handle) {
  ...
  VkResult result = vkCreateWin32SurfaceKHR(instance_.instance, &surface_create_info,
