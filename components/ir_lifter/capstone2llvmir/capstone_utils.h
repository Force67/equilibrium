...
static std::map<cs_arch, std::string> capstoneArchStringMap = {
    {CS_ARCH_ARM, "CS_ARCH_ARM"},   {CS_ARCH_ARM64, "CS_ARCH_ARM64"},
    {CS_ARCH_MIPS, "CS_ARCH_MIPS"}, {CS_ARCH_X86, "CS_ARCH_X86"},
    {CS_ARCH_PPC, "CS_ARCH_PPC"},   {CS_ARCH_SPARC, "CS_ARCH_SPARC"},
    {CS_ARCH_SYSZ, "CS_ARCH_SYSZ"}, {CS_ARCH_XCORE, "CS_ARCH_XCORE"},
    {CS_ARCH_MAX, "CS_ARCH_MAX"},   {CS_ARCH_ALL, "CS_ARCH_ALL"}};
