...
llvm::IRBuilder<> _generateIfThen(llvm::Value* cond,
                                  llvm::IRBuilder<>& irb,
                                  bool reverse) {
...
std::pair<llvm::IRBuilder<>, llvm::IRBuilder<>> generateIfThenElse(
  ...
  return std::make_pair(llvm::IRBuilder<>(bodyIf->getTerminator()),
...
std::pair<llvm::IRBuilder<>, llvm::IRBuilder<>> generateWhile(
  ...
  branch = llvm::BranchInst::Create(body, after, irb.getTrue(),
  ...
  return std::make_pair(llvm::IRBuilder<>(before->getTerminator()),
