...
class Capstone2LlvmIrTranslator_impl
    : virtual public Capstone2LlvmIrTranslator {
 public:
  Capstone2LlvmIrTranslator_impl(cs_arch a,
                                 cs_mode basic,
                                 cs_mode extra,
                                 llvm::Module* m);
  ...
  //
 public:
  virtual TranslationResult translate(const uint8_t* bytes,
                                      std::size_t size,
                                      retdec::common::Address a,
                                      llvm::IRBuilder<>& irb,
                                      std::size_t count = 0,
                                      bool stopOnBranch = false) override;
  virtual TranslationResultOne translateOne(const uint8_t*& bytes,
                                            std::size_t& size,
                                            retdec::common::Address& a,
 ...
 public:
  ...
  virtual llvm::StoreInst* isSpecialAsm2LlvmInstr(
  ...
  virtual llvm::BranchInst* isInConditionCallFunctionCall(
      llvm::CallInst* c) const override;
  ...
  virtual llvm::BranchInst* isInConditionReturnFunctionCall(
      llvm::CallInst* c) const override;
  ...
  virtual llvm::BranchInst* isInConditionBranchFunctionCall(
      llvm::CallInst* c) const override;
  ...
  virtual llvm::BranchInst* isInConditionCondBranchFunctionCall(
      llvm::CallInst* c) const override;
  ...
  virtual const std::set<llvm::Function*>& getPseudoAsmFunctions()
      const override;
  //
  //==============================================================================
 ...
 protected:
  ...
  llvm::Value* generateTypeConversion(llvm::IRBuilder<>& irb,
                                      llvm::Value* from,
                                      llvm::Type* to,
                                      eOpConv ct);
   ...
   * @param ct    convertion method by which will be opeands converted to the
   * resut type.
   * @return      If result type for convertion can be used with specified
   * conversion method returns param to. Otherwise will this method try to
   * create suitable type for convertion method ct with size of llvm type of
   * param to.
   */
  llvm::Type* _checkTypeConversion(llvm::IRBuilder<>& irb,
                                   llvm::Type* to,
                                   eOpConv ct);
  //
  //==============================================================================
 ...
 protected:
  ...
  virtual llvm::StoreInst* generateSpecialAsm2LlvmInstr(llvm::IRBuilder<>& irb,
                                                        cs_insn* i);
  virtual void generateCallFunction();
  virtual llvm::CallInst* generateCallFunctionCall(llvm::IRBuilder<>& irb,
                                                   llvm::Value* t);
  virtual llvm::CallInst* generateCondCallFunctionCall(llvm::IRBuilder<>& irb,
                                                       llvm::Value* cond,
                                                       llvm::Value* t);
  virtual void generateReturnFunction();
  virtual llvm::CallInst* generateReturnFunctionCall(llvm::IRBuilder<>& irb,
                                                     llvm::Value* t);
  virtual llvm::CallInst* generateCondReturnFunctionCall(llvm::IRBuilder<>& irb,
                                                         llvm::Value* cond,
                                                         llvm::Value* t);
  virtual void generateBranchFunction();
  virtual llvm::CallInst* generateBranchFunctionCall(llvm::IRBuilder<>& irb,
                                                     llvm::Value* t);
  virtual void generateCondBranchFunction();
  virtual llvm::CallInst* generateCondBranchFunctionCall(llvm::IRBuilder<>& irb,
                                                         llvm::Value* cond,
                                                         llvm::Value* t);
   ...
   * @return Loaded value.
   */
  virtual llvm::Value* loadRegister(uint32_t r,
                                    llvm::IRBuilder<>& irb,
                                    llvm::Type* dstType = nullptr,
                                    eOpConv ct = eOpConv::THROW) = 0;
  virtual llvm::Value* loadOp(CInsnOp& op,
                              llvm::IRBuilder<>& irb,
   ...
   * @param strictCheck	If set to true opCnt will be equal as number of
   * operands. Otherwise will load N last operands.
   * @param loadType	Type of loaded value. (not relevant if nullptr)
   * @param dstType	Desired type of loaded value (not changed if nullptr).
   * @param ct		Used conversion. Defaultly NOTHING as "do not convert".
   */
  std::vector<llvm::Value*> _loadOps(CInsn* ci,
                                     llvm::IRBuilder<>& irb,
                                     std::size_t opCnt,
   ...
   * is of integer type then `ict` convertion will be used on all other
   * opernads. If first perand is floting point type then used convertion will
   * be `fct`.
   *
   * @param ci
   * @param irb
  ...
  llvm::Value* loadOpUnary(CInsn* ci,
                           llvm::IRBuilder<>& irb,
                           llvm::Type* dstType = nullptr,
                           llvm::Type* loadType = nullptr,
  ...
  std::pair<llvm::Value*, llvm::Value*> loadOpBinary(CInsn* ci,
                                                     llvm::IRBuilder<>& irb,
                                                     eOpConv ict,
                                                     eOpConv fct);
  ...
  llvm::Value* loadOpBinaryOp0(CInsn* ci,
                               llvm::IRBuilder<>& irb,
                               llvm::Type* ty = nullptr);
  llvm::Value* loadOpBinaryOp1(CInsn* ci,
                               llvm::IRBuilder<>& irb,
                               llvm::Type* ty = nullptr);
  ...
  std::tuple<llvm::Value*, llvm::Value*, llvm::Value*>
  loadOpQuaternaryOp1Op2Op3(CInsn* ai, llvm::IRBuilder<>& irb);
  //
  //==============================================================================
  ...
  //
 protected:
  llvm::Value* generateCarryAdd(llvm::Value* add,
                                llvm::Value* op0,
                                llvm::IRBuilder<>& irb);
  llvm::Value* generateCarryAddC(llvm::Value* op0,
                                 llvm::Value* op1,
                                 llvm::IRBuilder<>& irb,
                                 llvm::Value* cf = nullptr);
  llvm::Value* generateCarryAddInt4(llvm::Value* op0,
                                    llvm::Value* op1,
                                    llvm::IRBuilder<>& irb);
  llvm::Value* generateCarryAddCInt4(llvm::Value* op0,
                                     llvm::Value* op1,
                                     llvm::IRBuilder<>& irb,
                                     llvm::Value* cf = nullptr);
  llvm::Value* generateOverflowAdd(llvm::Value* add,
                                   llvm::Value* op0,
                                   llvm::Value* op1,
                                   llvm::IRBuilder<>& irb);
  llvm::Value* generateOverflowAddC(llvm::Value* add,
                                    llvm::Value* op0,
                                    llvm::Value* op1,
                                    llvm::IRBuilder<>& irb,
                                    llvm::Value* cf = nullptr);
  llvm::Value* generateOverflowSub(llvm::Value* sub,
                                   llvm::Value* op0,
                                   llvm::Value* op1,
                                   llvm::IRBuilder<>& irb);
  llvm::Value* generateOverflowSubC(llvm::Value* sub,
                                    llvm::Value* op0,
                                    llvm::Value* op1,
                                    llvm::IRBuilder<>& irb,
                                    llvm::Value* cf = nullptr);
  llvm::Value* generateBorrowSub(llvm::Value* op0,
                                 llvm::Value* op1,
                                 llvm::IRBuilder<>& irb);
  llvm::Value* generateBorrowSubC(llvm::Value* sub,
                                  llvm::Value* op0,
                                  llvm::Value* op1,
                                  llvm::IRBuilder<>& irb,
                                  llvm::Value* cf = nullptr);
  llvm::Value* generateBorrowSubInt4(llvm::Value* op0,
                                     llvm::Value* op1,
                                     llvm::IRBuilder<>& irb);
  llvm::Value* generateBorrowSubCInt4(llvm::Value* op0,
                                      llvm::Value* op1,
                                      llvm::IRBuilder<>& irb,
                                      llvm::Value* cf = nullptr);
  //
 ...
 protected:
  ...
  llvm::Function* getPseudoAsmFunction(cs_insn* insn,
  ...
  void translatePseudoAsmOp0FncOp0(cs_insn* i,
                                   CInsn* ci,
                                   llvm::IRBuilder<>& irb);
  // Binary.
  void translatePseudoAsmFncOp0Op1(cs_insn* i,
                                   CInsn* ci,
                                   llvm::IRBuilder<>& irb);
  void translatePseudoAsmOp0FncOp1(cs_insn* i,
                                   CInsn* ci,
                                   llvm::IRBuilder<>& irb);
  void translatePseudoAsmOp0FncOp0Op1(cs_insn* i,
                                      CInsn* ci,
                                      llvm::IRBuilder<>& irb);
  // Ternary.
  void translatePseudoAsmFncOp0Op1Op2(cs_insn* i,
                                      CInsn* ci,
                                      llvm::IRBuilder<>& irb);
  void translatePseudoAsmOp0FncOp1Op2(cs_insn* i,
                                      CInsn* ci,
                                      llvm::IRBuilder<>& irb);
  void translatePseudoAsmOp0FncOp0Op1Op2(cs_insn* i,
                                         CInsn* ci,
                                         llvm::IRBuilder<>& irb);
  // Quaternary.
  void translatePseudoAsmFncOp0Op1Op2Op3(cs_insn* i,
                                         CInsn* ci,
                                         llvm::IRBuilder<>& irb);
  void translatePseudoAsmOp0FncOp1Op2Op3(cs_insn* i,
                                         CInsn* ci,
                                         llvm::IRBuilder<>& irb);
  void translatePseudoAsmOp0FncOp0Op1Op2Op3(cs_insn* i,
                                            CInsn* ci,
                                            llvm::IRBuilder<>& irb);
  void translatePseudoAsmOp0Op1FncOp0Op1Op2Op3(cs_insn* i,
                                               CInsn* ci,
                                               llvm::IRBuilder<>& irb);
  // Generic.
  virtual bool isOperandRegister(CInsnOp& op) = 0;
  virtual uint8_t getOperandAccess(CInsnOp& op);
  virtual void translatePseudoAsmGeneric(cs_insn* i,
                                         CInsn* ci,
                                         llvm::IRBuilder<>& irb);
