...
// This will trigger on Shipping mode aswell
// TODO: consider if a DCHECK is sufficient
#define IM_ASSERT(expr) BUGCHECK(expr)

// Disable exports of imgui symbols (noop)
#define IMGUI_API
