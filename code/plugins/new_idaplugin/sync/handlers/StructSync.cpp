...
namespace sync::create_struct {
  ...
  static bool React(SyncService &sc, va_list list)
  {
	...
	auto pack = CreateCreateStructDirect(buf,
	                                     get_struc_name(sid).c_str(),
	                                     struc->is_union());

	return GNetClient()->SendPacket(protocol::MsgType_sync_CreateStruct, buf, pack.Union());
  }
...
namespace sync::delete_struct {
  ...
  static bool React(SyncService &sc, va_list list)
  {
	...
	return GNetClient()->SendPacket(protocol::MsgType_sync_DeleteStruct, buf, pack.Union());
  }
...
namespace sync::rename_struct {
  ...
  static bool React(SyncService &sc, va_list list)
  {
	...
	return GNetClient()->SendPacket(protocol::MsgType_sync_RenameStruct, buf, pack.Union());
  }
...
namespace sync::rename_struct_member {
  ...
  static bool React(SyncService &sc, va_list list)
  {
	...
	return GNetClient()->SendPacket(protocol::MsgType_sync_RenameStructMember, buf, pack.Union());
  }
...
namespace sync::delete_struct_member {
  ...
  static bool React(SyncService &sc, va_list list)
  {
	...
	return GNetClient()->SendPacket(protocol::MsgType_sync_DeleteStructMember, buf, pack.Union());
  }
