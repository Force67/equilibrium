...
namespace sync::add_function {
  ...
  static bool React(SyncService &sc, va_list list)
  {
	...
	return GNetClient()->
		SendPacket(protocol::MsgType_sync_AddFunction, buf, pack.Union());
  }
...
namespace sync::delete_function {
  ...
  static bool React(SyncService &sc, va_list list)
  {
	...
	return GNetClient()->
		SendPacket(protocol::MsgType_sync_DeleteFunction, buf, pack.Union());
  }
...
namespace sync::set_function_start {
  ...
  static bool React(SyncService &sc, va_list list)
  {
	...
	return GNetClient()->
		SendPacket(protocol::MsgType_sync_SetFunctionStart, buf, pack.Union());
  }
...
namespace sync::set_function_end {
  ...
  static bool React(SyncService &sc, va_list list)
  {
	...
	return GNetClient()->
		SendPacket(protocol::MsgType_sync_SetFunctionEnd, buf, pack.Union());
  }
...
namespace sync::append_function_tail {
  ...
  static bool React(SyncService &sc, va_list list)
  {
	...
	network::FbsBuffer buf;
	auto pack = CreateAppendFunctionTail(buf, func->start_ea, 
		tail->start_ea, tail->end_ea);

	return GNetClient()->
		SendPacket(protocol::MsgType_sync_AppendFunctionTail, buf, pack.Union());
  }
...
namespace sync::delete_function_tail {
  ...
  static bool React(SyncService &sc, va_list list)
  {
	...
	return GNetClient()->
		SendPacket(protocol::MsgType_sync_DeleteFunctionTail, buf, pack.Union());
  }
...
namespace sync::change_function_tail_owner {
  ...
  static bool React(SyncService &sc, va_list list)
  {
	...
	network::FbsBuffer buf;
	auto pack = CreateChangeFunctionTailOwner(buf,
	            tail->start_ea, ownerFunc);

	return GNetClient()->
		SendPacket(protocol::MsgType_sync_ChangeFunctionTailOwner, buf, pack.Union());
  }
