...
// Heavily tweaked version of https://github.com/nxrighthere/ENet-CSharp
// Changed to suit our needs, e.g using a newer version of enet
...
namespace ENet
{
	...
	public struct Address
	{
		...
		public uint Host
        {
			get
            {
				return nativeAddress.host;
            }

            set
            {
				nativeAddress.host = value;
            }
        }
	}
