...
namespace database {
  ...
  public:
	...
	bool CreateProject(int32_t wksId, const std::string &name, const std::string &guid);
  ...
  public:
	...
	bool AddUpdate(int32_t type, int32_t user_id, const void *data, size_t dataLen);
