...
static const qt_meta_stringdata_UiController_t qt_meta_stringdata_UiController = {
  {
	  ...
	  QT_MOC_LITERAL(3, 24, 12), // "OpenSyncMenu"
	  QT_MOC_LITERAL(4, 37, 15), // "OpenAboutDialog"
	  QT_MOC_LITERAL(5, 53, 14)	 // "OnConfigureAct"

  },
  "UiController\0DoConnect\0\0OpenSyncMenu\0"
  "OpenAboutDialog\0OnConfigureAct"
};
