...
#define QT_MOC_LITERAL(idx, ofs, len)                          \
  Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
                                                          qptrdiff(offsetof(qt_meta_stringdata_UiController_t, stringdata0) + ofs - idx * sizeof(QByteArrayData)))
static const qt_meta_stringdata_UiController_t qt_meta_stringdata_UiController = {
  {
      QT_MOC_LITERAL(0, 0, 12),  // "UiController"
      QT_MOC_LITERAL(1, 13, 13), // "ToggleConnect"
      QT_MOC_LITERAL(2, 27, 0),  // ""
      QT_MOC_LITERAL(3, 28, 12), // "OpenSyncMenu"
      QT_MOC_LITERAL(4, 41, 15), // "OpenAboutDialog"
      QT_MOC_LITERAL(5, 57, 17)  // "OpenConfiguration"

  },
  "UiController\0ToggleConnect\0\0OpenSyncMenu\0"
