...
#define REG_HINTS_MARKER SCOLOR_ON "\xFF"
#define REG_HINTS_MARKER_LEN 2
#define SRCDBG_HINTS_MARKER SCOLOR_ON "\xFE"
...
//@{
//
#define WOPN_TAB                0x02 ///< attached by default to a tab. If not specified, the widget
                                     ///< will be inserted into its own, new floating area
#define WOPN_RESTORE            0x04 ///< if the widget was the only widget in a floating area the
                                     ///< last time it was closed, it will be restored as
                                     ///< floating, with the same position+size as before
#define WOPN_PERSIST            0x40 ///< widget will remain available when starting or stopping debugger sessions
...
#define IWID_STACK         (1ULL << BWN_STACK        ) ///< call stack        (17)
#define IWID_XREFS         (1ULL << BWN_XREFS        ) ///< xrefs             (18)
#define IWID_SEARCHS       (1ULL << BWN_SEARCH       ) ///< search results    (19)
...
#define IWID_DISASMS       (1ULL << BWN_DISASM       ) ///< disassembly views (29)
#define IWID_DUMPS         (1ULL << BWN_DUMP         ) ///< hex dumps         (30)
...
#define IWID_ALL           0xFFFFFFFFFFFFFFFF   ///< mask
//@}
...
struct chooser_t : public chooser_base_t
{
  ...
  /// \return idx      index of the selected item (cursor)
  ///         changed  what is changed
  virtual cbret_t idaapi edit(size_t /*n*/) { return cbret_t(); } //-V524 body is equal to del()
  ...
  /// \return idx      index of the selected item (cursor)
  ///         changed  what is changed
  inline virtual cbret_t idaapi enter(size_t n)
  {
